...
exprExistsInStmt :: (Expression SourceRange -> Bool) -> Statement SourceRange -> Bool
...
exprExistsInExpr :: (Expression SourceRange -> Bool)  -> Expression SourceRange -> Bool
...
exprExistsInExprEx :: (Expression SourceRange -> Bool) -> Expression SourceRange -> Bool
