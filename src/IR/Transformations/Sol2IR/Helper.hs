...
exprExistsInExpr e e'@(Unary _ ue) = e == e' || exprExistsInExprEx e ue
exprExistsInExpr e e'@(Binary _ lhs rhs) = e == e' || exprExistsInExprEx e lhs || exprExistsInExprEx e rhs
exprExistsInExpr e e'@(Ternary _ cond lhs rhs) = e == e' || exprExistsInExprEx e cond || exprExistsInExprEx e lhs || exprExistsInExprEx e rhs
...
exprExistsInExpr e e'@(MemberAccess me _) = e == e' || exprExistsInExprEx e me
...
exprExistsInExprEx :: Expression -> Expression -> Bool
