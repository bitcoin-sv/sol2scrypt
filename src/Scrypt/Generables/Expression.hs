...
binaryOp2Str Scr.LShift = " << "
binaryOp2Str Scr.RShift = " >> "
binaryOp2Str Scr.OrAssign = " |= "
binaryOp2Str Scr.AndAssign = " &= "
binaryOp2Str Scr.XorAssign = " ^= "
binaryOp2Str Scr.LShiftAssign = " <<= "
binaryOp2Str Scr.RShiftAssign = " >>= "
binaryOp2Str Scr.Or = " | "
binaryOp2Str Scr.And  = " & "
binaryOp2Str Scr.Xor  = " ^ "
binaryOp2Str op =  error $ "unimplemented genCode for binary op `" ++ show op ++ "`"
